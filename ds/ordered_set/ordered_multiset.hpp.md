...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"ds/ordered_set/ordered_multiset.hpp\"\n\n\n\n#include <cassert>\n\
  ...
  verifiedWith:
  - verify/ds/ordered_set/ordered_multiset.test.cpp
  - verify/ds/ordered_set/ordered_set.test.cpp
documentation_of: ds/ordered_set/ordered_multiset.hpp
layout: document
