...
| Category | Headers |
| --- | --- |
| [`union_find/`](union_find/) | `dsu.hpp`, `dsu_monoid.hpp`, `potentialized_dsu.hpp`, `persistent_dsu.hpp` |
| [`segment_tree/`](segment_tree/) | `segtree.hpp`, `lazy_segtree.hpp`, `dual_segtree.hpp`, and their persistent variants |
...
| [`ordered_set/`](ordered_set/) | Ordered sets and multisets, with mutable and persistent variants |
