...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"ds/dynamic_tree/lazy_path_link_cut_tree.hpp\"\n\n\n\n#include\
    \ <cassert>\n#include <concepts>\n#include <type_traits>\n#include <utility>\n\
...
documentation_of: ds/dynamic_tree/lazy_path_link_cut_tree.hpp
layout: document
...
`m1une::ds::LazyPathLinkCutTree<ActedMonoid>` maintains a dynamic
