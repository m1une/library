...
data:
  ...
  bundledCode: "#line 1 \"monoid/rolling_hash.hpp\"\n\n\n\n#include <utility>\n#line\
    ...
    \ a clean wrapper around the mathematical logic defined in string::RollingHash.\n\
    ...
    \ \n//   }\n//   Segtree<RH> seg(init_data);\ntemplate <long long Base, long long\
    ...
    \ a, const value_type& b) {\n        return {\n            StringRH::combine(a.first,\
    \ b.first, b.second),\n            (static_cast<__int128_t>(a.second) * b.second)\
    \ % Mod\n        };\n    }\n\n    // Helper to securely create a monoid element\
    \ from a single character (or integer).\n    // Delegates to string::RollingHash\
    \ to hide the base/mod mechanics.\n    static constexpr value_type make(long long\
...
layout: document
redirect_from:
- /library/monoid/rolling_hash.hpp
- /library/monoid/rolling_hash.hpp.html
