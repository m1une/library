...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"monoids/monoids/min_monoid.hpp\"\n\n\n\n#include <algorithm>\n\
  ...
  verifiedWith: []
documentation_of: monoids/monoids/min_monoid.hpp
layout: document
redirect_from:
- /library/monoids/monoids/min_monoid.hpp
- /library/monoids/monoids/min_monoid.hpp.html
