...
data:
  ...
  bundledCode: "#line 1 \"verify/utilities/arrow_dice.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3206\"\n\n#line\
    \ 1 \"utilities/dice.hpp\"\n\n\n\n#include <array>\n#include <cstddef>\n#include\
    \ <optional>\n#include <stdexcept>\n#include <string>\n#include <utility>\n#include\
    \ <vector>\n\nnamespace m1une {\nnamespace utilities {\n\nenum class DiceFace\
    \ : std::size_t {\n    top,\n    bottom,\n    north,\n    south,\n    east,\n\
    ...
    \ ArrowDice&) = default;\n};\n\n}  // namespace utilities\n}  // namespace m1une\n\
    \n\n#line 4 \"verify/utilities/arrow_dice.test.cpp\"\n\n#include <cassert>\n#include\
    \ <iostream>\n#line 9 \"verify/utilities/arrow_dice.test.cpp\"\n\nnamespace {\n\
  ...
  verifiedWith: []
documentation_of: verify/utilities/arrow_dice.test.cpp
layout: document
redirect_from:
- /verify/verify/utilities/arrow_dice.test.cpp
- /verify/verify/utilities/arrow_dice.test.cpp.html
