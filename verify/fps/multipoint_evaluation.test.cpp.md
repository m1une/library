...
data:
  ...
  bundledCode: "#line 1 \"verify/fps/multipoint_evaluation.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/multipoint_evaluation\"\n\n#include <iostream>\n\
    #include <vector>\n\n#line 1 \"fps/multipoint_evaluation.hpp\"\n\n\n\n#include\
    ...
    \ namespace fps\n}  // namespace m1une\n\n\n#line 8 \"fps/multipoint_evaluation.hpp\"\
    ...
    }\n\n}  // namespace fps\n}  // namespace m1une\n\n\n#line 8 \"verify/fps/multipoint_evaluation.test.cpp\"\
    \n\nusing mint = m1une::math::modint998244353;\nusing Fps = m1une::fps::FormalPowerSeries<mint>;\n\
    \nint main() {\n    std::ios::sync_with_stdio(false);\n    std::cin.tie(nullptr);\n\
    \n    int n, m;\n    std::cin >> n >> m;\n    Fps polynomial(n);\n    std::vector<mint>\
    \ points(m);\n    for (mint& value : polynomial) std::cin >> value;\n    for (mint&\
    \ point : points) std::cin >> point;\n    std::vector<mint> result = m1une::fps::multipoint_evaluate(polynomial,\
    \ points);\n    for (int i = 0; i < m; i++) {\n        if (i) std::cout << ' ';\n\
    \        std::cout << result[i];\n    }\n    std::cout << '\\n';\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/fps/multipoint_evaluation.test.cpp
layout: document
redirect_from:
- /verify/verify/fps/multipoint_evaluation.test.cpp
- /verify/verify/fps/multipoint_evaluation.test.cpp.html
