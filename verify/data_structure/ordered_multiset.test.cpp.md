...
data:
  ...
  bundledCode: "#line 1 \"verify/data_structure/ordered_multiset.test.cpp\"\n#define\
    ...
    \ const {\n        std::vector<T> res;\n        res.reserve(size());\n       \
    \ dump_impl(root, res);\n        return res;\n    }\n};\n\n}  // namespace data_structure\n\
    }  // namespace m1une\n\n\n#line 4 \"verify/data_structure/ordered_multiset.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/data_structure/ordered_multiset.test.cpp
layout: document
redirect_from:
- /verify/verify/data_structure/ordered_multiset.test.cpp
- /verify/verify/data_structure/ordered_multiset.test.cpp.html
