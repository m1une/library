...
data:
  ...
  bundledCode: "#line 1 \"verify/data_structure/ordered_set.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/ordered_set\"\n\n#line 1 \"data_structure/ordered_set.hpp\"\
    \n\n\n\n#line 1 \"data_structure/ordered_multiset.hpp\"\n\n\n\n#include <cassert>\n\
    ...
    \ const {\n        std::vector<T> res;\n        res.reserve(size());\n       \
    \ dump_impl(root, res);\n        return res;\n    }\n};\n\n}  // namespace data_structure\n\
    }  // namespace m1une\n\n\n#line 5 \"data_structure/ordered_set.hpp\"\n\n#line\
    \ 10 \"data_structure/ordered_set.hpp\"\n\nnamespace m1une {\nnamespace data_structure\
    \ {\n\ntemplate <typename T, typename Compare = std::less<T>>\nstruct OrderedSet\
    ...
    \ data_structure\n}  // namespace m1une\n\n\n#line 4 \"verify/data_structure/ordered_set.test.cpp\"\
    \n\n#include <iostream>\n\nvoid fast_io() {\n    std::ios_base::sync_with_stdio(false);\n\
    \    std::cin.tie(nullptr);\n}\n\nint main() {\n    fast_io();\n\n    int N, Q;\n\
    \    std::cin >> N >> Q;\n\n    m1une::data_structure::OrderedSet<int> st;\n \
    \   for (int i = 0; i < N; i++) {\n        int a;\n        std::cin >> a;\n  \
    \      st.insert(a);\n    }\n\n    while (Q--) {\n        int type, x;\n     \
    \   std::cin >> type >> x;\n\n        if (type == 0) {\n            st.insert(x);\n\
    \        } else if (type == 1) {\n            st.erase(x);\n        } else if\
  ...
  requiredBy: []
  timestamp: '2026-06-14 13:58:34+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/data_structure/ordered_set.test.cpp
layout: document
redirect_from:
- /verify/verify/data_structure/ordered_set.test.cpp
- /verify/verify/data_structure/ordered_set.test.cpp.html
