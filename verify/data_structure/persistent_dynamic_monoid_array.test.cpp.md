...
data:
  ...
  bundledCode: "#line 1 \"verify/data_structure/persistent_dynamic_monoid_array.test.cpp\"\
    \n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n\n#line 1 \"data_structure/persistent_dynamic_monoid_array.hpp\"\
    \n\n\n\n#include <cassert>\n#include <chrono>\n#include <concepts>\n#include <cstdint>\n\
    ...
    \        return res;\n    }\n};\n\n}  // namespace data_structure\n}  // namespace\
    \ m1une\n\n\n#line 4 \"verify/data_structure/persistent_dynamic_monoid_array.test.cpp\"\
    \n\n#include <algorithm>\n#line 7 \"verify/data_structure/persistent_dynamic_monoid_array.test.cpp\"\
    \n#include <iostream>\n#include <numeric>\n#include <random>\n#include <string>\n\
    #line 13 \"verify/data_structure/persistent_dynamic_monoid_array.test.cpp\"\n\n\
    struct StringMonoid {\n    using value_type = std::string;\n\n    static std::string\
    \ id() {\n        return \"\";\n    }\n\n    static std::string op(const std::string&\
    \ a, const std::string& b) {\n        return a + b;\n    }\n};\n\nstd::string\
    \ join(const std::vector<std::string>& a, int l, int r) {\n    std::string res;\n\
    \    for (int i = l; i < r; i++) res += a[i];\n    return res;\n}\n\nint main()\
    \ {\n    using Array = m1une::data_structure::PersistentDynamicMonoidArray<StringMonoid>;\n\
    \n    Array a = {\"a\", \"b\", \"c\", \"d\", \"e\"};\n    Array b = a.insert(2,\
...
layout: document
redirect_from:
- /verify/verify/data_structure/persistent_dynamic_monoid_array.test.cpp
- /verify/verify/data_structure/persistent_dynamic_monoid_array.test.cpp.html
