...
data:
  ...
  bundledCode: "#line 1 \"verify/data_structure/persistent_dsu_library_checker.test.cpp\"\
    \n#define PROBLEM \"https://judge.yosupo.jp/problem/persistent_unionfind\"\n\n\
    #include <bits/stdc++.h>\nusing namespace std;\n\n#line 1 \"data_structure/persistent_dsu.hpp\"\
    \n\n\n\n#line 9 \"data_structure/persistent_dsu.hpp\"\n\nnamespace m1une {\nnamespace\
    \ data_structure {\n\nstruct PersistentDsu {\n   private:\n    struct Node {\n\
    \        int val;\n        int l, r;\n\n        Node() : val(0), l(0), r(0) {}\n\
    \        explicit Node(int value) : val(value), l(0), r(0) {}\n        Node(int\
    \ value, int left, int right) : val(value), l(left), r(right) {}\n    };\n\n \
    ...
    }  // namespace m1une\n\n\n#line 7 \"verify/data_structure/persistent_dsu_library_checker.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/data_structure/persistent_dsu_library_checker.test.cpp
layout: document
redirect_from:
- /verify/verify/data_structure/persistent_dsu_library_checker.test.cpp
- /verify/verify/data_structure/persistent_dsu_library_checker.test.cpp.html
