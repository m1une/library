...
data:
  ...
  bundledCode: "#line 1 \"verify/data_structure/combined_sparse_table.test.cpp\"\n\
    ...
    \ identity element defaults to the maximum possible value of type T, but can be\
    \ overridden.\ntemplate <typename T, T Id = std::numeric_limits<T>::max()>\nstruct\
    \ Min {\n    using value_type = T;\n\n    // Returns the identity element for\
    \ minimum.\n    static constexpr T id() { return Id; }\n\n    // Returns the minimum\
    \ of a and b.\n    static constexpr T op(const T& a, const T& b) { return std::min(a,\
    \ b); }\n};\n\n}  // namespace monoid\n}  // namespace m1une\n\n// END: monoid/min.hpp\n\
    #line 5 \"verify/data_structure/sparse_table.test.cpp\"\n\n#include <iostream>\n\
    #line 126 \"verify/data_structure/combined_sparse_table.test.cpp\"\n\nvoid fast_io()\
  ...
  code: "// BEGIN: verify/data_structure/sparse_table.test.cpp\n#line 1 \"verify/data_structure/sparse_table.test.cpp\"\
    \n#define PROBLEM \"https://judge.yosupo.jp/problem/staticrmq\"\n\n// BEGIN: data_structure/sparse_table.hpp\n\
    #line 3 \"data_structure/sparse_table.hpp\"\n\n#include <vector>\n#include <cassert>\n\
    #include <bit>\n// BEGIN: monoid/concept.hpp\n#line 3 \"monoid/concept.hpp\"\n\
    \n#include <concepts>\n\nnamespace m1une {\nnamespace monoid {\n\n// Concept to\
  ...
  verifiedWith: []
documentation_of: verify/data_structure/combined_sparse_table.test.cpp
layout: document
redirect_from:
- /verify/verify/data_structure/combined_sparse_table.test.cpp
- /verify/verify/data_structure/combined_sparse_table.test.cpp.html
