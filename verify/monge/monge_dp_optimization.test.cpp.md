...
data:
  ...
  bundledCode: "#line 1 \"verify/monge/monge_dp_optimization.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include <algorithm>\n#include\
    \ <cassert>\n#include <iostream>\n#include <limits>\n#include <vector>\n\n#line\
    ...
    \ - prefix[left];\n            };\n\n            auto result = m1une::monge::knuth_optimization(n,\
    ...
    \        m1une::monge::Larsch<long long> larsch(n, value);\n        assert(larsch.size()\
    ...
    \        };\n\n            auto result = m1une::monge::larsch_shortest_path(n,\
...
layout: document
redirect_from:
- /verify/verify/monge/monge_dp_optimization.test.cpp
- /verify/verify/monge/monge_dp_optimization.test.cpp.html
