...
data:
  ...
  bundledCode: "#line 1 \"verify/math/primality_test.test.cpp\"\n#define PROBLEM \"\
    https://judge.yosupo.jp/problem/primality_test\"\n\n#include <cstdint>\n#include\
    ...
    \  }\n    return result;\n}\n\n}  // namespace math\n}  // namespace m1une\n\n\
    \n#line 7 \"verify/math/primality_test.test.cpp\"\n\nint main() {\n    std::ios::sync_with_stdio(false);\n\
    \    std::cin.tie(nullptr);\n\n    int query_count;\n    std::cin >> query_count;\n\
    \    while (query_count--) {\n        uint64_t value;\n        std::cin >> value;\n\
...
layout: document
redirect_from:
- /verify/verify/math/primality_test.test.cpp
- /verify/verify/math/primality_test.test.cpp.html
