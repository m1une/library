...
data:
  ...
  bundledCode: "#line 1 \"verify/ds/union_find/dsu.test.cpp\"\n#define PROBLEM \"\
    https://judge.yosupo.jp/problem/unionfind\"\n\n#include <bits/stdc++.h>\n#line\
    \ 1 \"ds/union_find/dsu.hpp\"\n\n\n\n#line 7 \"ds/union_find/dsu.hpp\"\n\nnamespace\
    \ m1une {\nnamespace ds {\n\nstruct Dsu {\n   private:\n    int _n;\n    // parent_or_size[i]\
    ...
    \  result.end());\n        return result;\n    }\n};\n\n}  // namespace ds\n}\
    \  // namespace m1une\n\n\n#line 5 \"verify/ds/union_find/dsu.test.cpp\"\nusing\
  ...
  verifiedWith: []
documentation_of: verify/ds/union_find/dsu.test.cpp
layout: document
redirect_from:
- /verify/verify/ds/union_find/dsu.test.cpp
- /verify/verify/ds/union_find/dsu.test.cpp.html
