...
data:
  ...
  bundledCode: "#line 1 \"acted_monoid/range_add_range_arg_min.hpp\"\n\n\n\n#include\
    ...
    \ monoid {\n\n// Monoid for finding the optimal value (minimum by default) and\
    ...
    \ two elements based on the Compare functor.\n    static constexpr value_type\
    ...
    \ f, const value_type& x) {\n        if (x.second == -1) return x;  // Do not\
    \ apply to the identity element\n        return {x.first + f, x.second};\n   \
    \ }\n\n    // Helper for initializing a leaf node\n    static constexpr value_type\
    \ make(const T& val, int index) {\n        return BaseMonoid::make(val, index);\n\
    \    }\n};\n\n}  // namespace acted_monoid\n}  // namespace m1une\n\n\n"
