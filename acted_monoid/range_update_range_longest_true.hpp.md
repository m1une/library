...
data:
  ...
  bundledCode: "#line 1 \"acted_monoid/range_update_range_longest_true.hpp\"\n\n\n\
    ...
    \ length of a contiguous subarray\n// where all elements satisfy a certain condition\
    ...
    \ x;\n        bool v = f.value();\n        \n        // If updating to 'true',\
    \ the entire length satisfies the condition.\n        // If updating to 'false',\
    \ zero elements satisfy the condition.\n        return {\n            x.len,\n\
    \            v ? x.len : 0,\n            v ? x.len : 0,\n            v ? x.len\
